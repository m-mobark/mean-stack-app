...
module.exports = "<div class=\"container\">\n  <div class=\"jumbotron\">\n      <h3>To Do App wellcome!</h3>\n    <h5>mohammedmobark96@gmail.com</h5>\n  </div>\n\n  \n</div>\n\n\n\n"
...
var MainComponent = (function () {
    ...
    // editTask(taskId) {
    //   this._flash.show('', { cssClass: 'alert-success'});
    //   return false;
    // }
...
var RegisterComponent = (function () {
    ...
    RegisterComponent.prototype.onRegister = function () {
        ...
        if (!this.name || !this.email || !this.password) {
            this._flash.show('required', { cssClass: 'alert-danger' });
            return false;
        }
        var user = {
            name: this.name,
